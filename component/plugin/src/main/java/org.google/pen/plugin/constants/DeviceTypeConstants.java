...
package org.google.pen.plugin.constants;
...
public class DeviceTypeConstants {
    public final static String DEVICE_TYPE = "ipen";
    public final static String DEVICE_PLUGIN_DEVICE_NAME = "DEVICE_NAME";
    public final static String DEVICE_PLUGIN_DEVICE_ID = "ipen_DEVICE_ID";
    public final static String STATE_ON = "ON";
    public final static String STATE_OFF = "OFF";

    //sensor events summarized table name
    public static final String SENSOR_TYPE1_EVENT_TABLE = "ORG_WSO2_IOT_DEVICES_ink";
    public static final String SENSOR_TYPE2_EVENT_TABLE = "ORG_WSO2_IOT_DEVICES_bolt";
    public static final String DATA_SOURCE_NAME = "jdbc/ipenDM_DB";
    public final static String DEVICE_TYPE_PROVIDER_DOMAIN = "carbon.super";
    public final static String SENSOR_TYPE1 = "ink";
    public final static String SENSOR_TYPE2 = "bolt";

    //mqtt trasport related constants
    public static final String MQTT_ADAPTER_NAME = "ink_mqtt";
    ...
    public static final String SUBSCRIBED_TOPIC = "carbon.super/ipen/+/ink";
    ...
    public final static String SENSOR_TYPE1_STREAM_DEFINITION = "org.wso2.iot.devices.ink";
    public final static String SENSOR_TYPE1_STREAM_DEFINITION_VERSION = "1.0.0";

    public final static String SENSOR_TYPE2_STREAM_DEFINITION = "org.wso2.iot.devices.bolt";
