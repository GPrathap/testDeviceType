...
import org.google.pen.plugin.impl.feature.DeviceTypeFeatureManager;
...
/**
 * This represents the pen implementation of DeviceManagerService.
 */
public class DeviceTypeManager implements DeviceManager {
    ...
    public boolean enrollDevice(Device device) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Enrolling a new pen device : " + device.getDeviceIdentifier());
            }
            ...
            String msg = "Error while enrolling the pen device : " + device.getDeviceIdentifier();
            log.error(msg, e);
    ...
    public boolean modifyEnrollment(Device device) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Modifying the pen device enrollment data");
            }
            DeviceTypeDAO.beginTransaction();
            ...
            String msg = "Error while updating the enrollment of the pen device : " +
    ...
    public boolean disenrollDevice(DeviceIdentifier deviceId) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Dis-enrolling pen device : " + deviceId);
            }
            DeviceTypeDAO.beginTransaction();
            ...
            String msg = "Error while removing the pen device : " + deviceId.getId();
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
        return status;
    ...
    public boolean isEnrolled(DeviceIdentifier deviceId) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Checking the enrollment of pen device : " + deviceId.getId());
            }
            Device iotDevice =
            ...
            String msg = "Error while checking the enrollment status of pen device : " +
                    deviceId.getId();
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
    ...
    public Device getDevice(DeviceIdentifier deviceId) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Getting the details of pen device : " + deviceId.getId());
            }
            device = deviceTypeDAO.getDeviceTypeDAO().getDevice(deviceId.getId());
        } catch (DeviceMgtPluginException e) {
            String msg = "Error while fetching the pen device : " + deviceId.getId();
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
        return device;
    ...
    public boolean updateDeviceInfo(DeviceIdentifier deviceIdentifier, Device device) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("updating the details of pen device : " + deviceIdentifier);
            }
            DeviceTypeDAO.beginTransaction();
            status = deviceTypeDAO.getDeviceTypeDAO().updateDevice(device);
            DeviceTypeDAO.commitTransaction();
            ...
            String msg =
                    "Error while updating the pen device : " + deviceIdentifier;
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
        return status;
    ...
    public List<Device> getAllDevices() throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Fetching the details of all pen devices");
            }
            devices = deviceTypeDAO.getDeviceTypeDAO().getAllDevices();
        } catch (DeviceMgtPluginException e) {
            String msg = "Error while fetching all pen devices.";
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
        return devices;
